...
onMounted(() => {
  ...
  //设置地面精灵的位置
  groundSprite.position.set(0, 600 - 50);
  ...
  //设置仙人掌精灵的位置
  cactusSprite.x = 800 / 2;
  cactusSprite.y = 600 - 50 - 50;
  ...
  app.ticker.add((delta: any) => {
    ...
    if (jumpSprite.visible) {
      ...
      if (jumpSprite.y > 600 - 50 - 50) {
        jumpSprite.y = 800 - 50 - 50;
        jumpVelocity = 20;
        jumpSprite.x = 60;
        jumpSprite.y = 600 - 50 - 50;
        jumpSprite.visible = false;
